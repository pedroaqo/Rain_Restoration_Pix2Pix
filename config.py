...
TRAIN_DIR = "Imagens/Double Train"
VAL_DIR = "Imagens/Double Validation"
LEARNING_RATE = 2e-4
BATCH_SIZE = 16
NUM_WORKERS = 2
IMAGE_SIZE = 256
...
transform_only_input = A.Compose([A.HorizontalFlip(p=0.5),A.ColorJitter(p=0.2),A.Normalize(mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5], max_pixel_value=255.0,),ToTensorV2()])
